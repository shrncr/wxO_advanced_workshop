...
# orchestrate connections configure -a wx_gw_creds --env live -k key_value -t team
# Set the credentials for the live environment
# orchestrate connections set-credentials -a wx_gw_creds --env live -e "api_key=$OPENAI_API_KEY"