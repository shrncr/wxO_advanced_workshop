#!/bin/bash
# This script sets up a connection to the Claude API using Orchestrate CLI.
...
orchestrate connections add -a claude_creds
...
# orchestrate connections configure -a claude_creds --env live -k key_value -t team
# Set the credentials for the live environment
# orchestrate connections set-credentials -a claude_creds --env live -e "api_key=$CLAUDE_API_KEY"