#!/bin/bash
# This script sets up a connection to the Gemini API using Orchestrate CLI.
...
# orchestrate connections configure -a gemini_creds --env live -k key_value -t team
# Set the credentials for the live environment
# orchestrate connections set-credentials -a gemini_creds --env live -e "api_key=$GEMINI_API_KEY"